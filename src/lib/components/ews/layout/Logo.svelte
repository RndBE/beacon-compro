...
{#if colored}
  <span
    ...
    style="
      ...
      background:url(/demo/ews/img/logo-be.png) center / contain no-repeat;
    "
  ></span>
{:else}
  <span
    ...
    style="
      ...
      -webkit-mask:url(/demo/ews/img/logo-be.png) center / contain no-repeat;
      mask:url(/demo/ews/img/logo-be.png) center / contain no-repeat;
    "
  ></span>
{/if}
