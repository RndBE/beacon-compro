...
>
	...
	<div
		...
		style="background: radial-gradient(ellipse at center, #D97706 0%, transparent 70%);"
	></div>
		...
		>
			...
			>
				<div
					...
					style="background: #FEF9C3; color: #D97706; border: 1px solid rgba(217,119,6,0.15);"
				>
		...
		<div class="grid md:grid-cols-2 gap-6">
			{#each products as product, i}
				<a
					...
					class="group relative rounded-[28px] overflow-hidden min-h-[480px] flex flex-col justify-end bg-zinc-100 transition-transform duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(217,119,6,0.3)]"
